...
public class LiveProjectController {
	...
	public ResponseEntity<LiveProject> getByProj(@PathVariable String projId){
		return new ResponseEntity<LiveProject>(liveProjectService.getByProj(projId),HttpStatus.OK);
	}
	...
	public ResponseEntity<LiveProject> search(@PathVariable String projName,@RequestBody LiveProject liveProject){
